...
## DINOv3 Demo
Check out one of my favorite new AI models - DINOv3. This model from meta provides unsupervised image segmentation in a similar manner to unsupervised text generation. Because of this, it can find similarity within an unlabeled image. This model acts as a foundational image model because it's embedding space is "dense" with features, so it can perform image segmentation on many different types of objects without fine tuning. [DINOv3 Demo](https://github.com/david-love121/DINOv3-demo)


## Website 
I just finished my new portfolio website. Check out the [live website](https://david-love121.github.io/) or the [repository](https://github.com/david-love121/svelte-developer-portfolio)
